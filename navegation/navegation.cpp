    ...
    ui(new Ui::Navegation)
{
    ...
    connect(ui->ToXlsxDeal, &QPushButton::clicked, this, &Navegation::on_XlsxDealButton_clicked);
}
...
void Navegation::on_XlsxDealButton_clicked()
{
    emit display(XLSX_DEAL_PAGE);
}
